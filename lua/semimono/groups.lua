...
M.treesitter = {
    ...
    TSAttribute = { fg = c.fg },
    TSBoolean = { fg = c.cyan, bg = c.none },
    TSCharacter = { fg = c.cyan },
    TSComment = { fg = c.gray05, bg = c.none },
    TSConditional = { fg = c.blue },
    TSConstant = { fg = c.fg },
    TSConstBuiltin = { fg = c.cyan, italic = true },
    TSConstMacro = { fg = c.cyan },
    TSConstructor = { fg = c.gray07 },
    TSError = { fg = c.red },
    TSException = { fg = c.yellow },
    TSField = { fg = c.cyan },
    TSFloat = { fg = c.cyan },
    TSFunction = { fg = c.fg },
    TSFuncBuiltin = { fg = c.fg },
    TSFuncMacro = { fg = c.blue },
    TSInclude = { fg = c.blue },
    TSKeyword = { fg = c.blue },
    TSKeywordFunction = { fg = c.blue },
    TSKeywordOperator = { fg = c.yellow },
    TSKeywordReturn = { fg = c.blue },
    TSLabel = { fg = c.cyan },
    TSMethod = { fg = c.bright_blue },
    ...
    TSPunctDelimiter = { fg = c.gray05 },
    TSPunctBracket = { fg = c.gray05 },
    TSPunctSpecial = { fg = c.green },
    TSRepeat = { fg = c.blue },
    TSString = { fg = c.cyan },
    ...
    TSSymbol = { fg = c.green },
    TSTag = { fg = c.yellow },
    TSTagAttribute = { fg = c.fg, italic = true },
    TSTagDelimiter = { fg = c.gray05 },
    TSText = { fg = c.fg },
    TSStrong = { fg = c.bright_white },
    TSEmphasis = { fg = c.bright_white },
    TSUnderline = { fg = c.bright_white },

    TSTitle = { fg = c.fg, bg = c.none, bold = true },
    TSLiteral = { fg = c.fg },
    TSURI = { fg = c.cyan },
    TSMath = { fg = c.blue },
    TSTextReference = { fg = c.yellow },
    TSEnvironment = { fg = c.blue },
    TSEnvironmentName = { fg = c.bright_blue },
    TSNote = { fg = c.blue, italic = true },
    TSWarning = { fg = c.yellow, italic = true },
    TSDanger = { fg = c.red, italic = true },
    TSType = { fg = c.fg },
